...
const DarkLogo = () => (
  <svg className="fill-current text-primary w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 312.999 312.999">
    <path
...
const LightLogo = () => (
  <svg className="fill-current text-primary w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 302.4 302.4">
    <path
