...
const DarkLogo = () => (
  <svg className="fill-current text-primary-green w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 312.999 312.999">
    <path
...
const LightLogo = () => (
  <svg className="fill-current text-primary-green w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 302.4 302.4">
    <path
...
const ModeSwitch = () => {
  ...
  return (<div className="cursor-pointer transform hover:scale-110" title="mode-switch" onClick={onSwitchClick}>
